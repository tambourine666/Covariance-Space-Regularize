...
def get_command_line_parser():
    ...
    # parser.add_argument('-a', type=float, default=0.5, help='coefficient of the cov loss')
    # parser.add_argument('-cov_balance', type=float, default=0.01, help='weight of the cov loss')
    ...
    parser.add_argument('-cov_restriction', action='store_true')
    parser.add_argument('-cov_balance', type=float, default=0.001)
    parser.add_argument('-incremental_cov_balance', type=float, default=0.001)

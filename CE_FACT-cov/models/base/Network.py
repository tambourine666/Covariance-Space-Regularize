...
class MYNET(nn.Module):
    ...
    def update_fc_ft_training_vae(self, new_fc, dataloader, session):
        ...
        self.fc.weight.data[
        self.args.base_class + self.args.way * (session - 1):self.args.base_class + self.args.way * session, :].copy_(new_fc.data)

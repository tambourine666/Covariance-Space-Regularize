...
def get_visualize_dataloader(args, index,train=False):

    if args.dataset == 'cifar100':
        trainset = args.Dataset.CIFAR100(root=args.dataroot, train=train, download=True, index=index, base_sess=True,autoaug=0)
        ...
        trainset = args.Dataset.CUB200(root=args.dataroot, train=train, index=index, base_sess=True,autoaug=0)
        ...
        trainset = args.Dataset.MiniImageNet(root=args.dataroot, train=train, index=index, base_sess=True,autoaug=0)
